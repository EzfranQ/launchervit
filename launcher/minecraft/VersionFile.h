...
class VersionFile : public ProblemContainer {
   ...
   public: /* data */
    /// LauncherVit: order hint for this version file if no explicit order is set
    int order = 0;

    /// LauncherVit: human readable name of this package
    QString name;

    /// LauncherVit: package ID of this package
    QString uid;

    /// LauncherVit: version of this package
    QString version;

    /// LauncherVit: DEPRECATED dependency on a Minecraft version
    ...
    /// LauncherVit: class to launch legacy Minecraft with (embed in a custom window)
    QString appletClass;

    /// Mojang: Minecraft launch arguments (may contain placeholders for variable substitution)
    QString minecraftArguments;

    /// LauncherVit: Additional JVM launch arguments
    ...
    /// LauncherVit: list of tweaker mod arguments for launchwrapper
    QStringList addTweakers;

    /// Mojang: list of libraries to add to the version
    QList<LibraryPtr> libraries;

    /// LauncherVit: list of maven files to put in the libraries folder, but not in classpath
    QList<LibraryPtr> mavenFiles;

    /// LauncherVit: list of agents to add to JVM arguments
    QList<Agent> agents;

    /// The main jar (Minecraft version library, normally)
    LibraryPtr mainJar;

    /// LauncherVit: list of attached traits of this version file - used to enable features
    QSet<QString> traits;

    /// LauncherVit: list of jar mods added to this version
    QList<LibraryPtr> jarMods;

    /// LauncherVit: list of mods added to this version
    QList<LibraryPtr> mods;

    /**
     * LauncherVit: set of packages this depends on
     * NOTE: this is shared with the meta format!!!
     */
    Meta::RequireSet m_requires;

    /**
     * LauncherVit: set of packages this conflicts with
     * NOTE: this is shared with the meta format!!!
     */
