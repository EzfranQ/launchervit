...
LAUNCHER_APPID="com.launchervit.LauncherVit"
...
if command -v "inkscape" && command -v "icotool" && command -v "oxipng"; then
    ...
    svg2png ${LAUNCHER_APPID}.svg "$d/launchervit_16.png" 16 16
    svg2png ${LAUNCHER_APPID}.svg "$d/launchervit_24.png" 24 24
    svg2png ${LAUNCHER_APPID}.svg "$d/launchervit_32.png" 32 32
    svg2png ${LAUNCHER_APPID}.svg "$d/launchervit_48.png" 48 48
    svg2png ${LAUNCHER_APPID}.svg "$d/launchervit_64.png" 64 64
    svg2png ${LAUNCHER_APPID}.svg "$d/launchervit_128.png" 128 128
    svg2png ${LAUNCHER_APPID}.svg "$d/launchervit_256.png" 256 256

    oxipng --opt max --strip all --alpha --interlace 0 "$d/launchervit_"*".png"

    rm launchervit.ico && icotool -o launchervit.ico -c \
        "$d/launchervit_256.png"  \
        "$d/launchervit_128.png"  \
        "$d/launchervit_64.png"   \
        "$d/launchervit_48.png"   \
        "$d/launchervit_32.png"   \
        "$d/launchervit_24.png"   \
        "$d/launchervit_16.png"
else
